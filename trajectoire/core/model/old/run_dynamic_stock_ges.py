...
from trajectoire.core.model.dynamic_stock import (
    ...
    update_dwelling_stock_ges,
    run_dynamic_simulation_ges,
...
# === LOAD STOCK DATA ===
df_stock_2020 = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "dwelling_stock_per_epc" / "GES" / "dwelling_stock_before_renovation.csv", sep=';', index_col=[0,1])
df_stock_col_2020 = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "dwelling_stock_per_epc" / "GES" / "dwelling_stock_before_renovation_col.csv", sep=';', index_col=[0,1])
df_stock_ind_2020 = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "dwelling_stock_per_epc" / "GES" / "dwelling_stock_before_renovation_ind.csv", sep=';', index_col=[0,1])
...
pt_col_reno_hrs = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "GES" / "collective_dwelling" / "pt_surface_col_hrs.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
pt_ind_reno_hrs = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "GES" / "individual_dwelling" / "pt_surface_ind_hrs.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
### Pivot table from the Medium Renovation Scenarios
pt_col_reno_mrs = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "GES" / "collective_dwelling" / "pt_surface_col_mrs.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
pt_ind_reno_mrs = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "GES" / "individual_dwelling" / "pt_surface_ind_mrs.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
### Pivot table from the High Demolition Scenarios
pt_col_dem_hds = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "GES"/"collective_dwelling" / "pt_surface_col_hds.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
pt_ind_dem_hds = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "GES" /"individual_dwelling" / "pt_surface_ind_hds.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
### Pivot table from the Medium Demolition Scenarios
pt_col_dem_mds = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "GES" /"collective_dwelling" / "pt_surface_col_hds.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
pt_ind_dem_mds = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "GES" /"individual_dwelling" / "pt_surface_ind_hds.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)


# === RUN SIMULATION YEAR BY YEAR AND UPDATE THE RELEVANT PARTS ===
## High Renovation Scenario and Middle Demolition Scenario
### Collective dwellings
updated_df_stock_hrs_linear_mds_col, changes_reno_lists_hrs_linear_col, changes_dem_lists_mds_col, delta_hrs_linear_mds_col = run_dynamic_simulation_ges(
...
updated_df_stock_hrs_plateau_mds_col, changes_reno_lists_hrs_plateau_col, changes_dem_lists_mds_col, delta_hrs_plateau_mds_col = run_dynamic_simulation_ges(
    pt_col_reno_hrs, pt_col_dem_mds, df_stock_col_2020,
...
updated_df_stock_hrs_linear_mds_ind, changes_reno_lists_hrs_linear_ind, changes_dem_lists_mds_ind, delta_hrs_linear_mds_ind = run_dynamic_simulation_ges(
...
updated_df_stock_hrs_plateau_mds_ind, changes_reno_lists_hrs_plateau_ind, changes_dem_lists_mds_ind, delta_hrs_plateau_mds_ind = run_dynamic_simulation_ges(
    pt_ind_reno_hrs, pt_ind_dem_mds, df_stock_ind_2020,
...
### Collective dwellings
updated_df_stock_mrs_linear_hds_col, changes_reno_lists_mrs_linear_col, changes_dem_lists_hds_col, delta_mrs_linear_hds_col = run_dynamic_simulation_ges(
...
updated_df_stock_mrs_plateau_hds_col, changes_reno_lists_mrs_plateau_col, changes_dem_lists_hds_col, delta_mrs_plateau_hds_col = run_dynamic_simulation_ges(
    pt_col_reno_mrs, pt_col_dem_hds, df_stock_col_2020,
...
### Individual dwellings
updated_df_stock_mrs_linear_hds_ind, changes_reno_lists_mrs_linear_ind, changes_dem_lists_hds_ind, delta_mrs_linear_hds_ind = run_dynamic_simulation_ges(
...
updated_df_stock_mrs_plateau_hds_ind, changes_reno_lists_mrs_plateau_ind, changes_dem_lists_hds_ind, delta_mrs_plateau_hds_ind = run_dynamic_simulation_ges(
    pt_ind_reno_mrs, pt_ind_dem_hds, df_stock_ind_2020,
...
combined_iamdfs_reno_res.to_csv(RESULT_NEW_GES_PATH / "combined_reno_surface_iamdf.csv", sep=';')
...
combined_all_stock_nrj_iamdf.to_csv(RESULT_NEW_GES_PATH / "combined_all_stock_nrj_iamdf.csv", sep=';')
...
combined_reno_embodied_iamdf.to_csv(RESULT_NEW_GES_PATH / "combined_reno_embodied_iamdf.csv", sep=';')
...
combined_demolition_embodied_iamdf.to_csv(RESULT_NEW_GES_PATH / "combined_demolition_embodied_iamdf.csv", sep=';')
...
combined_iamdfs_stock_operational.to_csv(RESULT_NEW_GES_PATH / "combined_stock_operational_iamdf.csv", sep=';')
...
combined_embodied_iamdf.to_csv(RESULT_NEW_GES_PATH / "combined_all_stock_embodied_iamdf.csv", sep=';')
...
operational_bau.to_csv(RESULT_NEW_GES_PATH / "operational_bau.csv", sep=';')
...
combined_operational_iamdf.to_csv(RESULT_NEW_GES_PATH / "combined_all_stock_operational_iamdf.csv", sep=';')
...
fig_operational_bau_nrj = plot_operational_all_stock_nrj(operational_bau,
                                                     scenario_pattern='STEPS',
                                                     variable='Residential_dwelling',
                                                     title='Operational GHGE - STEPS - EPC GHGE',
                                                     figsize=(10,8))

fig_operational_s2_nrj = plot_operational_all_stock_nrj(operational_s2,
                                                     scenario_pattern='APS',
                                                     variable='Residential_dwelling',
                                                     title='Operational GHGE - APS - EPC GHGE',
                                                     figsize=(10,8))
...
#                                                                 scenario_pattern='STEPS',
#                                                                 variable='Residential_dwelling',
#                                                                 title='Cumulated operational GHGE - STEPS',
#                                                                 figsize=(10,8))
#
#
...
fig_operational_s2_nrj_cum = plot_cumulative_operational_all_stock_nrj(operational_s2,
                                                                scenario_pattern='APS',
                                                                variable='Residential_dwelling',
                                                                title='Cumulated operational GHGE - APS - EPC GHGE',
                                                                figsize=(10,8))
#
#
# # == WLC emissions ==
