...
from trajectoire.core.model.housing_needs import (
    ...
    calculate_nrj_new_construction,
    calculate_combined_operational_stock_iamdf,
    calculate_cumulated_combined_operational_stock_iamdf,
    calculate_cumulated_nrj_new_construction
...
RESULT_NEW_DOUBLE_PATH = RESULT_DIRECTORY_PATH / "results_new_nrj"
...
dem = pyam.IamDataFrame(SCENARIOS_DIRECTORY_PATH  / "demolition" / "demolition_scenarios.csv", sep=';')
...
operational_ghge = pyam.IamDataFrame(pyam.IamDataFrame(SCENARIOS_DIRECTORY_PATH / "ghge" / "energy_carriers_scenarios.csv", sep=';'))
...
## Actual stock in 2020
stock_2020_shab = 2890212593
stock_2020_shab_col = 907528175
stock_2020_shab_ind = 1982684418
...
combined_housing_needs_iamdf.to_csv(RESULT_HOUSING_DIRECTORY_PATH / 'housing_needs_iamdf.csv', sep=';')
...
## MRS and HDS, e.g. least ambitious
...
## HRS and HDS, e.g. most ambitious
df_s2_construction = run_construction_pyam(combined_construction_needs_from_population_growth_iamdf,
                                        ...
                                        new_scenario='S2',
                                        created_scenario_construction_name='AMB_construction')


df_s2_construction.timeseries().reset_index().to_csv(RESULT_HOUSING_DIRECTORY_PATH / "iamdf_amb_construction.csv", sep=';', index=False)
...
# CALCULATE ENERGY IN KWH EF
## Yearly values
combined_construction_nrj_iamdf = calculate_nrj_new_construction(combined_construction_iamdf)
combined_construction_nrj_iamdf.to_csv(RESULT_HOUSING_DIRECTORY_PATH / "combined_construction_nrj_iamdf.csv", sep=';')

## Cumulated values
combined_construction_nrj_cumulated_iamdf = calculate_cumulated_nrj_new_construction(combined_construction_nrj_iamdf)
combined_construction_nrj_cumulated_iamdf.to_csv(RESULT_HOUSING_DIRECTORY_PATH / "combined_construction_nrj_cumulated_iamdf.csv", sep=';')


# CALCULATE OPERATIONAL GHGE
## Yearly values
combined_construction_operational_yearly_iamdf = calculate_combined_operational_stock_iamdf(combined_construction_nrj_iamdf, operational_ghge)
...
## Cumulated values
combined_construction_operational_cumulated_iamdf = calculate_cumulated_combined_operational_stock_iamdf(combined_construction_nrj_iamdf, operational_ghge)
