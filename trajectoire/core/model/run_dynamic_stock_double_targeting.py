...
from trajectoire.core.model.plotting_functions import (
    ...
    wlc_graph_compare_scenarios_cum,
...
RESULT_NEW_DOUBLE_PATH = RESULT_DIRECTORY_PATH / "results_new_double_targeting"

SAVE_FIGURE = RESULT_NEW_DOUBLE_PATH / "figures"
...
# === LOAD STOCK DATA ===
df_stock_2020 = pd.read_excel(CALIBRATION_DIRECTORY_PATH / "dwelling_stock_per_epc" / "DOUBLE" / "dwelling_stock_before_renovation.xlsx", index_col=[0,1])
df_stock_col_2020 = pd.read_excel(CALIBRATION_DIRECTORY_PATH / "dwelling_stock_per_epc" / "DOUBLE" / "dwelling_stock_before_renovation_col.xlsx", index_col=[0,1])
df_stock_ind_2020 = pd.read_excel(CALIBRATION_DIRECTORY_PATH / "dwelling_stock_per_epc" / "DOUBLE" / "dwelling_stock_before_renovation_ind.xlsx", index_col=[0,1])
...
pt_col_reno_hrs = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "DOUBLE" / "collective_dwelling" / "pt_surface_col_hrs.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
pt_ind_reno_hrs = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "DOUBLE" / "individual_dwelling" / "pt_surface_ind_hrs.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
### Pivot table from the Medium Renovation Scenarios
pt_col_reno_mrs = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "DOUBLE" / "collective_dwelling" / "pt_surface_col_mrs.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
pt_ind_reno_mrs = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "DOUBLE" / "individual_dwelling" / "pt_surface_ind_mrs.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
### Pivot table from the High Demolition Scenarios
pt_col_dem_hds = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "DOUBLE"/"collective_dwelling" / "pt_surface_col_hds.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
pt_ind_dem_hds = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "DOUBLE" /"individual_dwelling" / "pt_surface_ind_hds.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
### Pivot table from the Medium Demolition Scenarios
pt_col_dem_mds = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "DOUBLE" /"collective_dwelling" / "pt_surface_col_hds.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)
pt_ind_dem_mds = pd.read_csv(CALIBRATION_DIRECTORY_PATH / "pivot_tables" / "scenarios" / "DOUBLE" /"individual_dwelling" / "pt_surface_ind_hds.csv", sep=';', index_col=[0,1], header=[0,1], skipinitialspace=True)


# === RUN SIMULATION YEAR BY YEAR AND UPDATE THE RELEVANT PARTS ===
## High Renovation Scenario and Middle Demolition Scenario
### Collective dwellings
updated_df_stock_hrs_linear_mds_col, changes_reno_lists_hrs_linear_col, changes_dem_lists_mds_col, delta_hrs_linear_mds_col = run_dynamic_simulation_double(
    pt_col_reno_hrs_fossil, pt_col_reno_hrs_remaining, pt_col_dem_mds, df_stock_col_2020,
...
updated_df_stock_hrs_plateau_mds_col, changes_reno_lists_hrs_plateau_col, changes_dem_lists_mds_col, delta_hrs_plateau_mds_col = run_dynamic_simulation_double(
    pt_col_reno_hrs_fossil, pt_col_reno_hrs_remaining, pt_col_dem_mds, df_stock_col_2020,
...
updated_df_stock_hrs_linear_mds_ind, changes_reno_lists_hrs_linear_ind, changes_dem_lists_mds_ind, delta_hrs_linear_mds_ind = run_dynamic_simulation_double(
    pt_ind_reno_hrs_fossil, pt_ind_reno_hrs_remaining, pt_ind_dem_mds, df_stock_ind_2020,
...
updated_df_stock_hrs_plateau_mds_ind, changes_reno_lists_hrs_plateau_ind, changes_dem_lists_mds_ind, delta_hrs_plateau_mds_ind = run_dynamic_simulation_double(
    pt_ind_reno_hrs_fossil, pt_ind_reno_hrs_remaining, pt_ind_dem_mds, df_stock_ind_2020,
...
### Collective dwellings
updated_df_stock_mrs_linear_hds_col, changes_reno_lists_mrs_linear_col, changes_dem_lists_hds_col, delta_mrs_linear_hds_col = run_dynamic_simulation_double(
    pt_col_reno_mrs_fossil, pt_col_reno_mrs_remaining, pt_col_dem_hds, df_stock_col_2020,
...
updated_df_stock_mrs_plateau_hds_col, changes_reno_lists_mrs_plateau_col, changes_dem_lists_hds_col, delta_mrs_plateau_hds_col = run_dynamic_simulation_double(
    pt_col_reno_mrs_fossil, pt_col_reno_mrs_remaining, pt_col_dem_hds, df_stock_col_2020,
...
### Individual dwellings
updated_df_stock_mrs_linear_hds_ind, changes_reno_lists_mrs_linear_ind, changes_dem_lists_hds_ind, delta_mrs_linear_hds_ind = run_dynamic_simulation_double(
    pt_ind_reno_mrs_fossil, pt_ind_reno_mrs_remaining, pt_ind_dem_hds, df_stock_ind_2020,
...
updated_df_stock_mrs_plateau_hds_ind, changes_reno_lists_mrs_plateau_ind, changes_dem_lists_hds_ind, delta_mrs_plateau_hds_ind = run_dynamic_simulation_double(
    pt_ind_reno_mrs_fossil, pt_ind_reno_mrs_remaining, pt_ind_dem_hds, df_stock_ind_2020,
...
combined_iamdfs_reno_res.to_csv(RESULT_NEW_DOUBLE_PATH / "combined_reno_surface_iamdf.csv", sep=';')
...
#combined_iamdfs_stock_res.to_csv(RESULT_NEW_DOUBLE_PATH / "combined_stock_nrj_iamdf.csv", sep=';')

# ========================================
# Scripts NRJ
# ========================================
combined_construction_operational_cumulated_iamdf = pyam.IamDataFrame((RESULT_HOUSING_DIRECTORY_PATH / "combined_construction_nrj_cumulated_iamdf.csv"), sep=';')
...
combined_all_stock_nrj_iamdf.to_csv(RESULT_NEW_DOUBLE_PATH / "combined_all_stock_nrj_iamdf.csv", sep=';')
...
combined_reno_embodied_iamdf.to_csv(RESULT_NEW_DOUBLE_PATH / "combined_reno_embodied_iamdf.csv", sep=';')
...
combined_demolition_embodied_iamdf.to_csv(RESULT_NEW_DOUBLE_PATH / "combined_demolition_embodied_iamdf.csv", sep=';')
...
combined_iamdfs_stock_operational.to_csv(RESULT_NEW_DOUBLE_PATH / "combined_stock_operational_iamdf.csv", sep=';')
...
embodied_bau = embodied_all_stock(
                            ...
                            construction_scenario='BAU_construction_RE2020',
                            renovation_scenario='MRS_linear_RE2020',
                            demolition_scenario='HDS_RE2020',
...
embodied_s2 = embodied_all_stock(
                            ...
                            construction_scenario='AMB_construction_RE2020plus',
                            renovation_scenario='HRS_plateau_RE2020plus',
                            demolition_scenario='MDS_RE2020plus',
                            construction_variable='Residential_dwelling',
                            renovation_variable='Residential_dwelling',
                            demolition_variable='Residential_dwelling')
...
combined_embodied_iamdf.to_csv(RESULT_NEW_DOUBLE_PATH / "combined_all_stock_embodied_iamdf.csv", sep=';')
...
operational_bau.to_csv(RESULT_NEW_DOUBLE_PATH / "operational_bau.csv", sep=';')

operational_s2 = operational_all_stock(
                            combined_construction_operational_iamdf, combined_iamdfs_stock_operational,
                            construction_scenario='AMB_construction_SNBC',
                            remaining_scenario='HRS_plateau_MDS_SNBC',
                            created_scenario_name='APS')
...
combined_operational_iamdf.to_csv(RESULT_NEW_DOUBLE_PATH / "combined_all_stock_operational_iamdf.csv", sep=';')
...
fig_embodied_bau = plot_embodied_all_stock(embodied_bau,
                      title="Embodied GHGE - BAU (targeting)",
                      save_path=SAVE_FIGURE / "embodied_bau_targeted.png")

fig_embodied_s2 = plot_embodied_all_stock(embodied_s2,
                      title="Embodied GHGE - AMB (targeting)",
                      save_path=SAVE_FIGURE / "embodied_amb_targeted.png")

## CUMULATIVE
fig_embodied_bau_cum = plot_cumulative_all_stock_embodied(embodied_bau,
                      title="Cumulated embodied GHGE - BAU (targeting)",
                      save_path=SAVE_FIGURE / "embodied_bau_cum_targeted.png")

fig_embodied_s2_cum = plot_cumulative_all_stock_embodied(embodied_s2,
                      title="Cumulated embodied GHGE - AMB (targeting)",
                      save_path=SAVE_FIGURE / "embodied_bau_cum_targeted.png")
...
fig_operational_bau_dpe = plot_operational_all_stock_dpe(operational_bau,
                                                     ...
                                                     title='Operational GHGE - BAU (targeting)',
                                                     figsize=(10,8),
                                                     save_path=SAVE_FIGURE / "operational_bau_dpe_targeted.png")

fig_operational_s2_dpe = plot_operational_all_stock_dpe(operational_s2,
                                                     scenario_pattern='APS',
                                                     variable='Residential_dwelling',
                                                     title='Operational GHGE - AMB (targeting)',
                                                     figsize=(10,8),
                                                     save_path=SAVE_FIGURE / "operational_amb_dpe_targeted.png")
...
fig_operational_bau_nrj = plot_operational_all_stock_nrj(operational_bau,
                                                     ...
                                                     title='Operational GHGE - BAU (targeting)',
                                                     figsize=(10,8),
                                                     save_path=SAVE_FIGURE / "operational_bau_nrj_targeted.png")
...
fig_operational_s2_nrj = plot_operational_all_stock_nrj(operational_s2,
                                                     ...
                                                     title='Operational GHGE - AMB (targeting)',
                                                     figsize=(10,8),
                                                     save_path=SAVE_FIGURE / "operational_amb_nrj_targeted.png")
...
fig_operational_bau_dpe_cum = plot_cumulative_operational_all_stock_dpe(operational_bau,
                                                                scenario_pattern='STEPS',
                                                                variable='Residential_dwelling',
                                                                title='Cumulated operational GHGE - BAU (targeting)',
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "operational_bau_dpe_cum_targeted.png")


fig_operational_s2_dpe_cum = plot_cumulative_operational_all_stock_dpe(operational_s2,
                                                                scenario_pattern='APS',
                                                                variable='Residential_dwelling',
                                                                title='Cumulated operational GHGE - AMB (targeting)',
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "operational_amb_dpe_cum_targeted.png")
...
fig_operational_bau_nrj_cum = plot_cumulative_operational_all_stock_nrj(operational_bau,
                                                                ...
                                                                title='Cumulated operational GHGE - BAU (targeting)',
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "operational_bau_nrj_cum_targeted.png")
...
fig_operational_s2_nrj_cum = plot_cumulative_operational_all_stock_nrj(operational_s2,
                                                                ...
                                                                title='Cumulated operational GHGE - AMB (targeting)',
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "operational_amb_nrj_cum_targeted.png")
...
wlc_2050 = wlc_graph_compare_scenarios(operational_bau, operational_s2,
                                       ...
                                       scenario_name_1='BAU', scenario_name_2='AMB',
                                       variable='Residential_dwelling',
                                       year=2050,
                                       save_path=SAVE_FIGURE / "wlc_2050_targeted.png")


## Budgets
wlc_2050_cum = wlc_graph_compare_scenarios_cum(operational_bau, operational_s2,
                                       embodied_bau, embodied_s2,
                                       scenario_name_1='BAU', scenario_name_2='AMB',
                                       variable='Residential_dwelling',
                                       save_path=SAVE_FIGURE / "wlc_2050_targeted_cum.png")
...
fig_bau_nrj = plot_stock_nrj_twh(combined_all_stock_nrj_iamdf,
                                                                ...
                                                                variable='Residential_dwelling',
                                                                title='TWh - BAU (targeting)',
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "bau_nrj_targeted.png")

# fig_s2_nrj = plot_stock_nrj_twh(combined_all_stock_nrj_iamdf,
#                                                                 scenario_pattern='AMB_construction_HRS_plateau_MDS',
#                                                                 variable='Residential_dwelling',
#                                                                 title='TWh - AMB (targeting)',
#                                                                 figsize=(10,8),
#                                                                 save_path=SAVE_FIGURE / "amb_nrj_targeted.png")

# ========================================
# SENSIBILITY GRAPHS
# ========================================
# Operational range of values
operational_BAU_range = plot_range_operational_ghge(combined_operational_iamdf,
                                                         variable='Residential_dwelling',
                                                        scenario='BAU*',
                                                         title='Range of operational GHGE values for BAU (targeting)',
                                                        save_path=SAVE_FIGURE / "range_operational_bau_targeted.png")

operational_aps_range = plot_range_operational_ghge(combined_operational_iamdf,
                                                         variable='Residential_dwelling',
                                                        scenario='AMB*',
                                                         title='Range of operational GHGE values for AMB (targeting)',
                                                        save_path=SAVE_FIGURE / "range_operational_amb_targeted.png")


# Embodied range of values
embodied_BAU_range = plot_range_embodied_ghge(combined_embodied_iamdf,
                                                         variable='Residential_dwelling',
                                                        scenario='BAU*',
                                                         title='Range of embodied GHGE values for BAU (targeting)',
                                                        save_path=SAVE_FIGURE / "range_embodied_bau_targeted.png")

embodied_aps_range = plot_range_embodied_ghge(combined_embodied_iamdf,
                                                         variable='Residential_dwelling',
                                                        scenario='AMB*',
                                                         title='Range of embodied GHGE values for AMB (targeting)',
                                                        save_path=SAVE_FIGURE / "range_embodied_amb_targeted.png")