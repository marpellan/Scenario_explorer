...
RESULT_NEW_DOUBLE_PATH = RESULT_DIRECTORY_PATH / "results_new_double"
...
fig_operational_bau_dpe = plot_operational_all_stock_dpe(operational_bau,
                                                     ...
                                                     figsize=(10,8),
                                                     save_path=SAVE_FIGURE / "operational_bau_dpe.png")

fig_operational_s2_dpe = plot_operational_all_stock_dpe(operational_s2,
                                                     scenario_pattern='APS',
                                                     variable='Residential_dwelling',
                                                     title='Operational GHGE - AMB',
                                                     figsize=(10,8),
                                                     save_path=SAVE_FIGURE / "operational_amb_dpe.png")
#
fig_operational_bau_nrj = plot_operational_all_stock_nrj(operational_bau,
                                                     ...
                                                     title='Operational GHGE - BAU',
                                                     figsize=(10,8),
                                                     save_path=SAVE_FIGURE / "operational_bau_nrj.png")
...
fig_operational_s2_nrj = plot_operational_all_stock_nrj(operational_s2,
                                                     ...
                                                     title='Operational GHGE - AMB',
                                                     figsize=(10,8),
                                                     save_path=SAVE_FIGURE / "operational_amb_nrj.png")
...
fig_operational_bau_dpe_cum = plot_cumulative_operational_all_stock_dpe(operational_bau,
                                                                ...
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "operational_bau_dpe_cum.png")


fig_operational_s2_dpe_cum = plot_cumulative_operational_all_stock_dpe(operational_s2,
                                                                scenario_pattern='APS',
                                                                variable='Residential_dwelling',
                                                                title='Cumulated operational GHGE - AMB',
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "operational_amb_dpe_cum.png")
...
fig_operational_bau_nrj_cum = plot_cumulative_operational_all_stock_nrj(operational_bau,
                                                                ...
                                                                title='Cumulated operational GHGE - BAU',
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "operational_bau_nrj_cum.png")
...
fig_operational_s2_nrj_cum = plot_cumulative_operational_all_stock_nrj(operational_s2,
                                                                ...
                                                                title='Cumulated operational GHGE - AMB',
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "operational_amb_nrj_cum.png")
...
wlc_2050 = wlc_graph_compare_scenarios(operational_bau, operational_s2,
                                       ...
                                       variable='Residential_dwelling',
                                       year=2050,
                                       save_path=SAVE_FIGURE / "wlc_2050.png")
...
wlc_2050_cum = wlc_graph_compare_scenarios_cum(operational_bau, operational_s2,
                                       ...
                                       scenario_name_1='BAU', scenario_name_2='AMB',
                                       variable='Residential_dwelling',
                                       save_path=SAVE_FIGURE / "wlc_2050_cum.png")
...
fig_bau_nrj = plot_stock_nrj_twh(combined_all_stock_nrj_iamdf,
                                                                ...
                                                                title='TWh - BAU',
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "twh_bau.png")
...
fig_s2_nrj = plot_stock_nrj_twh(combined_all_stock_nrj_iamdf,
                                                                ...
                                                                title='TWh - AMB',
                                                                figsize=(10,8),
                                                                save_path=SAVE_FIGURE / "twh_amb.png")
...
operational_steps_range = plot_range_operational_ghge(combined_operational_iamdf,
                                                         variable='Residential_dwelling',
                                                         scenario='BAU*',
                                                         title='Range of operational GHGE values for BAU',
                                                         save_path=SAVE_FIGURE / "range_operational_bau.png")

operational_aps_range = plot_range_operational_ghge(combined_operational_iamdf,
                                                         variable='Residential_dwelling',
                                                         scenario='AMB*',
                                                         title='Range of operational GHGE values for AMB',
                                                         save_path=SAVE_FIGURE / "range_operational_amb.png")
...
embodied_steps_range = plot_range_embodied_ghge(combined_embodied_iamdf,
                                                         variable='Residential_dwelling',
                                                         scenario='BAU*',
                                                         title='Range of embodied GHGE values for BAU',
                                                         save_path=SAVE_FIGURE / "range_embodied_bau.png")

embodied_aps_range = plot_range_embodied_ghge(combined_embodied_iamdf,
                                                         variable='Residential_dwelling',
                                                         scenario='AMB*',
                                                         title='Range of embodied GHGE values for AMB',
                                                         save_path=SAVE_FIGURE / "range_embodied_amb.png")